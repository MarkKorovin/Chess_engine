    ...
    def Moves(self):
        ...
        if(0 <= self.x - 1 <= 7 and 0 <= self.y - 1 <= 7):
            if(Board[self.x - 1][self.y - 1] == '.'):
                if Move_into_check(self.color, self.x - 1, self.y - 1) == 1:
                    moves.append([self.x - 1, self.y - 1])
                #########ЗДЕСЬ ДОЛЖНА БЫТЬ ПРОВЕРКА ХОДА ПОД ШАХ
            else:
        ...
        if(0 <= self.y - 1 <= 7 and Board[self.x][self.y - 1] == '.'):
            if(Board[self.x][self.y - 1] == '.'):
                if Move_into_check(self.color, self.x, self.y - 1) == 1:
        ...
        if(0 <= self.x - 1 <= 7 and Board[self.x - 1][self.y] == '.'):
            if(Board[self.x - 1][self.y] == '.'):
                if Move_into_check(self.color, self.x - 1, self.y) == 1:

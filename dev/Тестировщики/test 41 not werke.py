...
class Pawn(Piece):
    ...
    def Moves(self):
        ...
        if self.color == 1:
            ...
            if self.x - 1 > 0 and Board.Board[self.x - 1][self.y] == '.':
                moves.append([self.x - 1, self.y])
                if self.x == 6 and Board.Board[self.x - 2][self.y] == '.':
                    moves.append([self.x - 2, self.y])
                    
            if self.x - 1 >= 0 and self.y - 1 >= 0 and Board.Board[self.x - 1][self.y - 1] != '.':
                if Board.Board[self.x - 1][self.y - 1].color == 0:
                    moves.append([self.x - 1, self.y - 1])
                
            if self.x - 1 >= 0 and self.y + 1 <= 7 and Board.Board[self.x - 1][self.y + 1] != '.':
                if Board.Board[self.x - 1][self.y + 1].color == 0:
                    moves.append([self.x - 1, self.y + 1])

        if self.color == 0:
            
            if self.x + 1 < 7 and Board.Board[self.x + 1][self.y] == '.':
                moves.append([self.x + 1, self.y])
                if self.x == 1 and Board.Board[self.x + 2][self.y] == '.':
                    moves.append([self.x + 2, self.y])
                    
            if self.x + 1 <= 7 and self.y + 1 <= 7 and Board.Board[self.x + 1][self.y + 1] != '.':
                if Board.Board[self.x + 1][self.y + 1].color == 1:
                    moves.append([self.x + 1, self.y + 1])   
            if self.x + 1 <= 7 and self.y - 1 >= 0 and Board.Board[self.x + 1][self.y - 1] != '.':
                if Board.Board[self.x + 1][self.y - 1].color == 1:
                    moves.append([self.x + 1, self.y - 1])
...
class Knight(Piece):
    ...
    def Moves(self):
        ...
        if 0 <= self.x - 1 <= 7 and 0 <= self.y - 2 <= 7:
            if Board.Board[self.x - 1][self.y - 2] == '.':
                moves.append([self.x - 1, self.y - 2])
            else:
                if abs(self.color - Board.Board[self.x - 1][self.y - 2].color) == 1:
                    moves.append([self.x - 1, self.y - 2])
                    
                
        if 0 <= self.x - 2 <= 7 and 0 <= self.y - 1 <= 7:
             if Board.Board[self.x - 2, self.y - 1] == '.':
                moves.append([self.x - 2, self.y - 1])
                
             else:
                if abs(self.color - Board.Board[self.x - 2, self.y - 1].color) == 1:
                    moves.append([self.x - 2, self.y - 1])
    ...
    def Moves(self):
        ...
        while a>=0 and b>=0:
            if Board.Board[a][b] == '.':
                ...
                if(abs(self.color - Board.Board[a][b]) == 1):
                    moves.append [a, b]
                break
...
class King(Piece):  
    ...
    def Moves(self):
        ...
        if(0 <= self.x - 1 <= 7 and 0 <= self.y - 1 <= 7 and Board.Board[self.x - 1][self.y - 1] == '.'):
            moves.append([self.x - 1, self.y - 1])
                
        if(0 <= self.y - 1 <= 7 and Board.Board[self.x][self.y - 1] == '.'):
            moves.append([self.x, self.y - 1])

        if(0 <= self.x + 1 <= 7 and 0 <= self.y - 1 <= 7 and Board.Board[self.x + 1][self.y - 1] == '.'):
            moves.append([self.x + 1, self.y - 1])
            
        if(0 <= self.x - 1 <= 7 and Board.Board[self.x - 1][self.y] == '.'):
            moves.append([self.x - 1, self.y])
